...
Reproducibility package for paper "A Collaborative Classroom Activity for Teaching Cloud Architecting" by Steven Santillán and [Cristina L. Abad](https://sites.google.com/fiec.espol.edu.ec/cv-cabad/english) from [ESPOL University](https://www.espol.edu.ec/en).

# How to cite:
Steven Santillan and Cristina L. Abad. "A Collaborative Classroom Activity for Teaching Cloud Architecting". _(to appear in) IEEE International Symposium on Parallel and Distributed Processing Workshops and Phd Forum (IPDPSW) - EduPar 2026.
